const Hero = () => (
  <div className="bg-gray-800">
    <div className="container xl:max-w-7xl mx-auto px-4 py-8 lg:px-8 lg:py-32">
      <div className="text-center">
        ...
        <p className="text-xl md:text-2xl md:leading-relaxed font-medium text-gray-300 lg:w-2/3 mx-auto">
          Hi, I&apos;m John Tsevdos, a software engineer from Athens, Greece (🇬🇷). I&apos;m a huge fan of full-stack{" "}
          <a
          ...
          . I provide consulting and training in these technologies, and co-organizing the{" "}
          <a
            href="https://www.meetup.com/react-to-react-athens-meetup/"
            target="_blank"
            rel="noreferrer"
            className="text-2xl font-bold text-blue-300 underline decoration-blue-300"
          >
