  ...
  <div className="bg-gray-800">
    <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-8">
      ...
      <p className="text-xlg md:text-2xl md:leading-relaxed font-medium text-gray-300 my-16">
        ...
        ,{" "}
        <a href="https://angular.io/" className="text-blue-300 underline" target="_blank" rel="noreferrer">
          Angular
        </a>
        ,{" "}
      ...
      <p className="text-xlg md:text-2xl md:leading-relaxed font-medium text-gray-300 my-16">
        ...
        ,{" "}
        <a href="https://www.ruby-lang.org/" className="text-blue-300 underline" target="_blank" rel="noreferrer">
          Ruby
        </a>{" "}
        (and{" "}
        ...
        ,{" "}
        <a href="https://www.postgresql.org/" className="text-blue-300 underline" target="_blank" rel="noreferrer">
          PostgreSQL
        </a>
        ,{" "}
        ...
        (currently using{" "}
        <a href="https://www.ubuntu.com" className="text-blue-300 underline" target="_blank" rel="noreferrer">
          Ubuntu
        </a>
        ),{" "}
        ...
        and always trying to do as much of{" "}
        <a
